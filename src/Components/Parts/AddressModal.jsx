    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[999]">
      <div className="bg-gray-900 p-6 rounded-xl w-full max-w-lg border border-white/10">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <input name="house_name" placeholder="House Name" onChange={handleChange} className="input"/>
          ...
          <input name="pin_code" placeholder="Pin Code" onChange={handleChange} className="input col-span-2"/>
        </div>
