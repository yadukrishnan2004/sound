...
const DashboardStats = () => {
    ...
    const [isBlocked, setIsBlocked] = useState(false); // Added missing state if needed

    useEffect(() => {
        const fetchUser = async () => {
            try {
                setLoading(true);
                // Using /user/ as per legacy code. 
                // My api service has baseURL already. 
                // So api.get('/user/') maps to BASE_URL + /user/
